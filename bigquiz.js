...
const questions = [
	...
	{question: "Name the missing ingredient? <div id='fragranceTitle'>Coco Noir EDP</div> <h4>Heart</h4> <ul> <li>Geranium</li> <li>Rose</li> <li>???</li> <li>Jasmine</li> </ul> <div>",
		answer1: "White Musk",
		answer2: "Vetiver",
		answer3: "Narcissus",
		answer4: "Tonka Bean",
	...
	{question: "Which of these is <b class='h'>not</b> a Facet of Allure EDP?",
		answer1: "Timeless Floral",
		answer2: "Fruity",
		answer3: "Oriental",
		answer4: "Sunny Spicy",
		answer5: "Imaginary Floral",
		correct: "D",
	},
	{question: "Which of these is <b class='h'>not</b> a Facet of Allure Sensuelle?",
		answer1: "Imaginary Floral",
		answer2: "Fruity",
		answer3: "Wood",
		answer4: "Sunny Spicy",
		answer5: "Fresh",
	...
	{question: "What is missing from the 'Imaginary Floral' facet? <div id='fragranceTitle'>Allure EDT</div> <h4>Imaginary Floral</h4> <ul> <li>???</li> <li>Honeysuckle Accord</li> <li>Water Lily Accord</li> </ul> <div>",
		answer1: "Jasmine Accord",
		answer2: "Citron Note",
		answer3: "Tulip Accord",
		answer4: "Iris Accord",
		answer5: "Magnolia Accord",
		correct: "E",
	},
	{question: "Which 2 ingredients have been increased in the Heart of Coco EDP? <div id='fragranceTitle'>Coco EDP</div> <h4>Heart</h4> <ul> <li>Rose</li> <li>Jasmine</li> <li>Ylang Ylang</li> <li>Orange Blossom Absolute</li> <li>Cloves</li> </ul>",
		answer1: "Rose & Jasmine",
		answer2: "Jasmine & Ylang Ylang",
		answer3: "Ylang Ylang & Orange Blossom Absolute",
		answer4: "Orange Blossom Absolute & Cloves",
		answer5: "Cloves & Rose",
		correct: "C",
	},
	{question: "Identify the fragrance from the composition: <ul> <li>Aldehydes</li> <li>Tuberose</li> <li>Orange Blossom</li> <li>Exotic Rose</li> </ul>",
		answer1: "Gardenia",
		answer2: "No. 22",
		answer3: "Cuir De Russie",
		answer4: "1957",
		answer5: "Boy",
		correct: "B",
	},
	{question: "Identify the fragrance from the composition: <ul> <li>Ylang Ylang</li> <li>Tuberose</li> <li>Exotic Rose</li> <li>Mimosa</li> </ul>",
		answer1: "Gardenia",
		answer2: "No. 22",
		answer3: "Cuir De Russie",
		answer4: "1957",
	...
	{question: "Identify the fragrance from the composition: <ul> <li>Ylang Ylang</li> <li>Sandalwood</li> <li>Tonka Bean</li> </ul>",
		answer1: "No. 22",
		answer2: "Beige",
		answer3: "Coromandel",
		answer4: "31 Rue Cambon",
		answer5: "Bois De Iles",
		correct: "E",
	},
	{question: "Identify the fragrance from the composition: <ul> <li>Ylang Ylang</li> <li>Exotic Jasmine</li> <li>Cistus Labdanum</li> <li>Birchwood</li> </ul>",
		answer1: "Bel Respiro",
		answer2: "Beige",
		answer3: "Cuir De Russie",
		answer4: "La Pausa",
	...
	{question: "Identify the fragrance from the composition: <ul> <li>Pear/Grapefruit</li> <li>Exotic Jasmine</li> <li>Iris</li> <li>Vetiver</li> </ul>",
		answer1: "Bel Respiro",
		answer2: "Beige",
		answer3: "Cuir De Russie",
		answer4: "La Pausa",
	...
	{question: "Identify the fragrance from the composition: <ul> <li>Geranium</li> <li>Ambrette Seed</li> <li>White Musk</li> </ul>",
		answer1: "Sycomore",
		answer2: "Boy Chanel",
		answer3: "No. 22",
		answer4: "No. 18",
